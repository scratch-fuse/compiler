...
var ScratchFunction = class _ScratchFunction {
  constructor(decl, exportName, module) {
    this.decl = decl;
...
var Context = class _Context {
  ...
  async processImports(program, importChain = /* @__PURE__ */ new Set()) {
    ...
    for (const stmt of program.body) {
      if (stmt.type === "ImportStatement") {
        ...
        try {
          let getTopModule2 = function(module) {
            let current = module;
   ...
   */
  compileModule(functionMap, scripts, errors, module, statements, parentPath = []) {
    const resolved = followAlias(module);
...
var Decompiler = class {
    ...
    switch (opcode) {
      ...
      case "data_itemoflist": {
        const memberExpr = {
          ...
          property: {
            type: "BinaryExpression",
            left: this.decompileReporter(inputs.INDEX.value),
            operator: "-",
            right: makeLiteral(1),
      ...
      case "operator_letter_of": {
        const memberExpr = {
          ...
          property: {
            type: "BinaryExpression",
            left: this.decompileReporter(inputs.LETTER.value),
            operator: "-",
            right: makeLiteral(1),
            // Convert 1-based to 0-based index
            line: 0,
   ...
   */
  tryMatchExternFromModule(block, module, supportSubstack, isTopLevel = false) {
  ...
  tryMatchHatBlock(hat) {
    const findHatExtern = (module, isTopLevel = false) => {
      for (const [memberName, entry] of module.externs) {
